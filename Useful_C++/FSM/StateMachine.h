...
Creation Date: 01.08.2020
	...
	Header file for state machine
		According to book's description, 
			it is an agent can own an instance of a state machine and 
			delegate the management of current states, global states, and previous states to it.
******************************************************************************/
#pragma once
#include "ReusableState.h"
